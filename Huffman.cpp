...
int main(){
	...
	//entering their corresponding frequencies
	int *freq=new int[n];
	...
	//ENCODING
	cout<<"\nEnter a string for its encoding (having only above characters): \n";
	string substring;
...
//cout<<"\n{Left:"<<r->left<<", symbol:"<<r->symbol<<", freqency:"<<r->frequency<<", right :"<<r->right<<"}";
